...
> Note: This repository keeps all Markdown documentation under `docs/`. When following command snippets, run them from the repository root (the folder containing `docker-compose.yml`).
...
See [SETUP.md](../01_getting_started/SETUP_GUIDE.md) for detailed local development instructions.
...
├── docs/                       # All Markdown docs + assets (start here)
│   ├── README.md               # Project overview
│   ├── INDEX.md                # Documentation index
│   ├── SETUP.md                # Local development setup
│   ├── assets/dashboard.html   # Lightweight UI demo (open in browser)
│   ├── services/               # Component documentation
│   │   ├── backend/README.md   # Backend docs
│   │   ├── frontend/README.md  # Frontend docs
│   │   └── retail-agent/       # Optional legacy agent docs
│   ├── reports/                # Test outputs / evidence
│   └── specs/                  # Project specification documents (DOCX)
├── scripts/                    # Utility scripts (start, deploy, tests)
├── dataverse_backend/          # FastAPI backend (source)
├── dataverse_frontend/         # Next.js 14 frontend (source)
└── retail-agent/               # Legacy Ollama agent (optional source)
```
...
### Optimization Tips
See [SETUP.md](../01_getting_started/SETUP_GUIDE.md) → "Performance Tuning"
...
For production, see [SETUP.md](../01_getting_started/SETUP_GUIDE.md) → "Production Deployment"

## 📖 Documentation

- **[SETUP.md](../01_getting_started/SETUP_GUIDE.md)** - Complete setup, configuration, and deployment
- **[Backend docs](../03_implementation_and_services/BACKEND_SERVICE_GUIDE.md)** - Backend architecture
- **[Frontend docs](../03_implementation_and_services/FRONTEND_SERVICE_GUIDE.md)** - Frontend guide
...
See [SETUP.md](../01_getting_started/SETUP_GUIDE.md) → "Troubleshooting" for detailed solutions.
...
See [SETUP.md](../01_getting_started/SETUP_GUIDE.md) → "Production Deployment"
...
1. Check [SETUP.md](../01_getting_started/SETUP_GUIDE.md) troubleshooting section
...
**Ready to get started?** See [SETUP.md](../01_getting_started/SETUP_GUIDE.md) for step-by-step instructions!
