...
### Utility Scripts ✅
```
[✅] Startup Script (scripts/START.bat)
...
### Then open docs/assets/dashboard.html in your browser
- Upload any CSV file
...
- **Code Examples**: Check scripts/demo_client.py
...
- **Run Tests**: Execute `python scripts/demo_client.py`

### Issues
- Backend not responding? Restart with scripts/START.bat
...
### Frontend Files
- `docs/assets/dashboard.html` - Main UI
...
- `scripts/START.bat` - One-click startup script
...
### Data Files
- `data/sample_products.csv` - Test dataset
- `data/sample_data.csv` - Test dataset
- `data/retail_mart_processed_v1.csv` - Test dataset
