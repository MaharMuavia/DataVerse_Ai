...
1. Check the [Backend docs](../03_implementation_and_services/BACKEND_SERVICE_GUIDE.md)
2. Check the [Frontend docs](../03_implementation_and_services/FRONTEND_SERVICE_GUIDE.md)
