...
`npm run dev` starts the FastAPI backend on `http://127.0.0.1:8000` when it is not already running, sets `NEXT_PUBLIC_DATAVERSE_API_URL`, and then starts the Next.js frontend on `http://127.0.0.1:3000`.
