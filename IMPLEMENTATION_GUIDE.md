...
│   └── DB_SETUP_GUIDE.py
│
├── dashboard.html               # Frontend UI (no dependencies)
...
```bash
curl -F "file=@sample_products.csv" http://localhost:8001/api/upload
```
...
3. Try with sample file: `sample_products.csv`
...
2. Review demo_client.py for usage examples
