...
| `dashboard.html` | Frontend UI (open in browser) |
...
### Immediate
1. ✅ Run START.bat (or manual startup)
...
4. Test with demo_client.py

### Code Examples
- See `demo_client.py` for API usage
- Check `dashboard.html` for frontend patterns
...
- 🚀 **Ready to Use**: Start immediately with START.bat
