...
# Upload CSV
path = r"C:\Users\mouav\OneDrive\Desktop\FINAL3\retail_mart_processed_v1.csv"
...
# Monkeypatch the client's call_model to return the example JSON string
...
# Perform query again to exercise successful DeepAnalyze flow
...
# Inspect session state (computed facts, trace)
